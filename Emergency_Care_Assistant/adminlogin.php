			...
			<div class="container">
				...
				<nav>
					<ul>
						...
						<li class="current"><a href="adminlogin.php">ADMIN Login</a></li>
			...
			<div class="container">
				<article id="main-collogin">
					...
					<form action="adminlogin.php" method="POST" class="login">
                        ...
                        <div>
							<input type="text" placeholder="Email Address" name="ADMIN_EMAIL">
						</div>
						<div>
							
							<input type="password" maxlength="50" placeholder="Password" name="ADMIN_PASSWORD">
						</div>
                        <button type="submit" class="login-button" name="alogbutton">Login</button>
					</form>
